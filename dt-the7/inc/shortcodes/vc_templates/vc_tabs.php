...
if ( 'vc_tour' == $this->shortcode) {
    $output .= "\n\t\t\t" . '<div class="wpb_tour_next_prev_nav clearfix"> <span class="wpb_prev_slide"><a href="#prev" title="'.__('Previous slide', LANGUAGE_ZONE).'">'.__('Previous slide', LANGUAGE_ZONE).'</a></span> <span class="wpb_next_slide"><a href="#next" title="'.__('Next slide', LANGUAGE_ZONE).'">'.__('Next slide', LANGUAGE_ZONE).'</a></span></div>';
}
