...
class Dt_Edit_Menu_Walker extends Walker_Nav_Menu {
	...
	function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
		...
		$default_mega_menu_fields = array(
			...
			'dt_mega_menu_image' => '',
			'dt_mega_menu_image_width' => 0,
			'dt_mega_menu_image_height' => 0,
				...
				<div class="<?php echo esc_attr( $mega_menu_container_classes ); ?>">
					...
					<div class="field-dt-image controls">
						...
						if ( function_exists('optionsframework_uploader') ) {
							...
							?>
							<input type="hidden" class="upload-image-width" name="menu-item-dt-image-width[<?php echo $item_id; ?>]" value="<?php echo absint($item->dt_mega_menu_image_width); ?>"/>
							<input type="hidden" class="upload-image-height" name="menu-item-dt-image-height[<?php echo $item_id; ?>]" value="<?php echo absint($item->dt_mega_menu_image_height); ?>"/>
							<?php
						}
						?>
					</div>
