...
vc_map( array(
    "base"		=> "my_hello_world",
    "name"		=> __("Hello World", LANGUAGE_ZONE),
    "class"		=> "",
    "icon"      => "icon-heart",
    "params"	=> array(
        array(
            ...
            "holder" => "h3",
            "class" => "",
            "heading" => __("Foo attribute", LANGUAGE_ZONE),
            "param_name" => "foo",
            "value" => __("I'm foo attribute", LANGUAGE_ZONE),
            "description" => __("Enter foo value.", LANGUAGE_ZONE)
        ),
        array(
            "type" => "textarea_html",
            "holder" => "div",
            ...
            "param_name" => "content",
            "value" => __("I'm hello world", LANGUAGE_ZONE),
            "description" => __("Enter your content.", LANGUAGE_ZONE)
        ),
        array(
            "type" => "dropdown",
            "heading" => __("Drop down example", LANGUAGE_ZONE),
            "param_name" => "my_dropdown",
            "value" => array(1, 2, "three"),
            "description" => __("One, two or three?", LANGUAGE_ZONE)
        ),
    )
) );
