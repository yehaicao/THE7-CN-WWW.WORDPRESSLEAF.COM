<div class="vc_row-fluid vc_shortcode-param vc_column">
    <div class="wpb_element_label"><?php _e( 'Font Family', LANGUAGE_ZONE ); ?></div>
...
<?php if ( isset( $fields['no_font_style'] ) && $fields['no_font_style'] === false || !isset( $fields['no_font_style'] ) ): ?>
    <div class="vc_row-fluid vc_shortcode-param vc_column">
        <div class="wpb_element_label"><?php _e( 'Font style', LANGUAGE_ZONE ); ?></div>
...
<div class="vc_row-fluid vc_shortcode-param vc_column">
    <div class="wpb_element_label"><?php _e( 'Google Fonts preview', LANGUAGE_ZONE ); ?>:</div>
    <div class="vc_google_fonts_form_field-preview-container">
        <span><?php _e( 'Grumpy wizards make toxic brew for the evil Queen and Jack.', LANGUAGE_ZONE ); ?></span>
    </div>
